  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-brand-bg px-6 py-12">
      ...
      <motion.div
        ...
        style={{ animationDelay: '-4s', transform: 'translateY(-100px)' }}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        >
          ...
          <motion.p variants={itemVariants} className="mt-3 text-brand-muted">
            Welcome back. Login to access your cockpit.
          </motion.p>
        </motion.div>
        ...
        >
          <motion.div variants={itemVariants} className="space-y-1">
            <label className="text-sm font-medium text-brand-text/80">Email or Username</label>
          ...
          <motion.div variants={itemVariants}>
            <motion.button
              type="submit"
              className="group relative w-full overflow-hidden rounded-xl bg-brand-violet py-3.5 font-medium text-white focus:outline-none focus:ring-2 focus:ring-brand-violet/50"
              whileHover={{ scale: 1.02, boxShadow: '0 8px 24px rgba(124,58,237,0.35)' }}
              whileTap={{ scale: 0.97 }}
        ...
        >
          ...
          <Link to="/signup" className="font-medium text-brand-teal hover:underline transition-colors">
            Register here
          </Link>
        </motion.p>
      </motion.div>
