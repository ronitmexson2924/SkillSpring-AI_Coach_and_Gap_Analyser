...
export default function AddSkillModal({ open, onClose, onSubmit }) {
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h2 className="mt-3 font-display text-3xl text-white">Extend the map</h2>
            ...
            <form className="mt-8 flex flex-1 flex-col" onSubmit={handleSubmit}>
              ...
              <input
                ...
                className="mt-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-white outline-none ring-brand-teal/40 transition focus:ring-2"
              ...
              <div className="mt-6 grid gap-5 md:grid-cols-2">
                <div>
                  ...
                  <select
                    ...
                    className="mt-3 w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-white outline-none ring-brand-teal/40 transition focus:ring-2"
                  >
                ...
                <div>
                  <label className="text-sm font-medium text-slate-200" htmlFor="skill-source">
                    Source
                  </label>
                  <select
                    id="skill-source"
              ...
              <div className="mt-6">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-medium text-slate-200" htmlFor="skill-proficiency">
                    Proficiency
                  </label>
                ...
                <div className="mt-4 flex flex-wrap gap-3">
                  {suggestions.map((skill) => (
                    <button
                      key={skill}
                      type="button"
                      onClick={() => setForm((state) => ({ ...state, name: skill }))}
                      className="rounded-full border border-white/10 px-4 py-2 text-sm text-slate-200 transition hover:border-brand-violet/60 hover:text-white"
                    >
                      {skill}
                    </button>
                  ))}
