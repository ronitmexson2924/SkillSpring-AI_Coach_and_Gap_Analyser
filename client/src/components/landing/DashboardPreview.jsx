...
function AnimatedStat({ label, value }) {
  ...
  return (
    <div ref={ref} className="rounded-[28px] border border-white/10 bg-white/5 p-5">
    ...
    <section className="section-shell py-24 md:py-32">
      <div className="mx-auto max-w-7xl">
        ...
        <motion.div
          ...
          className="relative mt-14 overflow-hidden rounded-[40px] border border-white/10 bg-gradient-to-br from-white/6 via-brand-surface to-black/40 p-6 shadow-glow md:p-8"
        >
          ...
          <div className="grid gap-6 lg:grid-cols-[0.65fr_0.35fr]">
            <div className="space-y-6">
              <div className="flex items-center justify-between rounded-[28px] border border-white/10 bg-black/20 px-5 py-4">
                <div>
                  ...
                  <h3 className="mt-1 font-display text-3xl text-white">Frontend Developer</h3>
                </div>
            ...
            <div className="space-y-6">
              ...
              <Card className="relative p-6">
                ...
                <div className="mt-5 rounded-3xl bg-brand-indigo/10 p-4 text-sm leading-7 text-indigo-100">
                  Your quickest path to improvement is closing testing and architecture gaps with one
                  focused project.
                </div>

                <motion.div
                  className="absolute -left-3 top-8 rounded-full border border-brand-teal/40 bg-brand-bg px-3 py-1 text-xs text-brand-teal"
                ...
                <motion.div
                  className="absolute -right-3 bottom-12 rounded-full border border-brand-violet/40 bg-brand-bg px-3 py-1 text-xs text-violet-200"
                  initial={{ opacity: 0, x: 20 }}
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true, margin: '-80px' }}
                  transition={{ delay: 1 }}
